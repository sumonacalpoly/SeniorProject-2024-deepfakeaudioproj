...
def main():
    ...
    if os.path.exists('x_train_testing_pa.npy') and os.path.exists('y_train_testing_pa.npy'):
        ...
        x_train_testing_pa, y_train_testing_pa = deepfake_audio_la.create_melspectrogram(testing_files_pa, testing_dir_pa, test_cm_path_pa, 128, 128)
    ...
    if os.path.exists('x_train_training_pa.npy') and os.path.exists('y_train_training_pa.npy'):
        ...
        x_train_training_pa, y_train_training_pa = deepfake_audio_la.create_melspectrogram(training_files_pa, training_dir_pa, train_cm_path_pa, 128, 128)
    ...
    if os.path.exists('x_train_val_pa.npy') and os.path.exists('y_train_val_pa.npy'):
        ...
        x_train_val_pa, y_train_val_pa = deepfake_audio_la.create_melspectrogram(validation_files_pa, validation_dir_pa, val_cm_path_pa, 128, 128)
    ...
    model1.save("deepfake_audio_model_pa13.h5")
